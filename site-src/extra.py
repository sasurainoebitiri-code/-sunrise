...
col('subsidy-ama-nagoya',
    'あま市・名古屋市で使える解体の補助金｜申請は「契約前」が鉄則',
    '解体の補助金（あま市・名古屋市）',
    '愛知県あま市の空家解体促進費補助金と、名古屋市の戸建木造住宅除却助成について、対象となる建物、補助額の上限、申請のタイミングを解体業者が整理しました。',
    8, ['building'],
    [('解体に使える補助金はあるの？',
      P('空き家や古い木造住宅の解体には、市町村が補助金を出していることがあります。制度の内容は市町村ごとに違い、年度によって変わることもあります。ここでは、当社の拠点があるあま市と、ご相談の多い名古屋市の制度を紹介します。')
      + '<div class="note"><b>いちばん大切なこと：</b>どちらの制度も、工事の契約や着工の前に申請し、交付の決定を受ける必要があります。先に契約してしまうと補助金を受けられません。</div>'),
     ('あま市「空家解体促進費補助金」',
